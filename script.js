...
function validateExists() { // validar se já existe uma tarefa com o mesmo nome
...
function newTask() { // adicionar uma nova tarefa
...
function showValues() { // mostrar os valores do localStorage
    let values = JSON.parse(localStorage.getItem(localStorageKey) || '[]')
...
function removeItem(data) { // remover items
    let values = JSON.parse(localStorage.getItem(localStorageKey) || '[]')
